SRCPATH=../../x264-master
prefix=/Users/mac/develop/x264Code/thin-x264/arm64
exec_prefix=${prefix}
...
STRIP=strip
INSTALL=install
AS=../../x264-master/tools/gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future -arch arm64
